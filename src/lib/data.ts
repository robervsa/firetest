...
import type { Expense, Group, AuditLog, ExpenseCategory } from './types';
...
export const mockExpenses: Expense[] = [
  { id: '1', description: 'Almuerzo de equipo', amount: 150.75, category: 'comida', date: '2024-05-20', group: 'Unidad de Marketing', user_id: '1' },
  { id: '2', description: 'Gasolina para vehículo de la empresa', amount: 65.00, category: 'combustible', date: '2024-05-20', group: 'Unidad de Ventas', user_id: '2' },
  { id: '3', description: 'Suministros de limpieza para oficina', amount: 80.20, category: 'limpieza', date: '2024-05-19', group: 'Oficina Central', user_id: '3' },
  { id: '4', description: 'Viaje en taxi para reunión con cliente', amount: 25.50, category: 'transporte', date: '2024-05-18', group: 'Unidad de Ventas', user_id: '4' },
  { id: '5', description: 'Papelería y toners', amount: 120.00, category: 'oficina', date: '2024-05-17', group: 'Oficina Central', user_id: '5' },
  { id: '6', description: 'Café y snacks para la oficina', amount: 45.30, category: 'comida', date: '2024-05-21', group: 'Oficina Central', user_id: '1' },
  { id: '7', description: 'Llenado de tanque flota #3', amount: 70.00, category: 'combustible', date: '2024-05-21', group: 'Logística', user_id: '2' },
];
